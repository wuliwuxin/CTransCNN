...
def cross_entropy(pred,
    ...
    Args:
        pred (torch.Tensor): The prediction with shape (N, C), C is the number
            of classes.
        label (torch.Tensor): The gt_fur label of the prediction.
...
def soft_cross_entropy(pred,
    ...
    Args:
        pred (torch.Tensor): The prediction with shape (N, C), C is the number
            of classes.
        label (torch.Tensor): The gt_fur label of the prediction with shape (N, C).
...
def binary_cross_entropy(pred,
    ...
    Args:
        ...
        label (torch.Tensor): The gt_fur label with shape (N, \*).
