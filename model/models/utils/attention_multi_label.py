...
class ShiftWindowMSA_Multi_label(BaseModule):
    ...
    def get_attn_mask(hw_shape, window_size, shift_size, device=None):
        if shift_size > 0:
            ...
            mask_windows = ShiftWindowMSA_Multi_label.window_partition(
...
class MultiheadAttention_Multi_label(BaseModule):
    ...
    def __init__(self,
                 ...
                 v_shortcut=False,
                 init_cfg=None):
        super(MultiheadAttention_Multi_label, self).__init__(init_cfg=init_cfg)
