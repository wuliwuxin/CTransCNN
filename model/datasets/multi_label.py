...
from model.core import average_performance, mAP
...
class MultiLabelDataset(BaseDataset):
    ...
    def evaluate(self,
        ...
        allowed_metrics = ['mAP', 'CP', 'CR', 'CF1', 'OP', 'OR', 'OF1', 'multi_auc', 'avg_hamming_loss',
                           'avg_zero_one_loss']
        eval_results = {}
        ...
        if len(set(metrics) - {'mAP'}) != 0:
            ...
            performance_keys = ['CP', 'CR', 'CF1', 'OP', 'OR', 'OF1', 'multi_auc', 'avg_hamming_loss',
                                'avg_zero_one_loss']
