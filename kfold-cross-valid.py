...
from model.utils import collect_env, get_root_logger, load_json_log
...
To resume a 5-fold cross-validation from an interrupted experiment:
    python tools/kfold-cross-valid.py $CONFIG --num-splits 5 --resume-from work_dirs/fold2/latest.resnet18_pth
