...
data = dict(
    ...
    train=dict(
        ...
        ann_file=data_root + 'tongue_train.txt',
        classes=data_root + 'multi_label_classes.txt',
        pipeline=train_pipeline),
    val=dict(
        type=dataset_type,
        data_prefix=data_root,
        ann_file=data_root + 'tongue_val.txt',
        classes=data_root + 'multi_label_classes.txt',
        pipeline=test_pipeline),
    test=dict(
        type=dataset_type,
        data_prefix=data_root,
        ann_file=data_root + 'tongue_test.txt',
        classes=data_root + 'multi_label_classes.txt',
        pipeline=test_pipeline))
